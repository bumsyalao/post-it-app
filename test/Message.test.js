...
//   it('should return status 400 when the group name is undefined',
//     (done) => {
//       request(app)
//       .post('/api/v1/group/user/message')
...
//   it('should return status 400 when the group name is missing',
//   (done) => {
//     request(app)
//     .post('/api/v1/group/user/message')
...
//   it('should return status 400 when the user name is undefined',
//   (done) => {
//     request(app)
//     .post('/api/v1/group/user/message')
...
//   it('should return status 400 when the user name is missing',
//   (done) => {
//     request(app)
//     .post('/api/v1/group/user/message')
//     .send({ notification, priority, user: '', group, message })
