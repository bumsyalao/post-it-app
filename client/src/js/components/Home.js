...
componentUnmount(){
  ...
  render() {
    return (
      <div>
        {!this.state.auth ? <section>
        <center><div><h1>Welcome to PostIt</h1>
        <p>PostIt is a simple application that allows friends and colleagues create groups for notifications.</p></div></center>
        <div className=" col-md-5 col-sm-12 form-margin2">
  
        <img src="http://www.affiliateprograms.com/blog/wp-content/uploads/2012/05/Group-Chat.jpg" height={342} width={442} />
      </div>
